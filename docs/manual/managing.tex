...
\item[protocol] This determines which message protocol will be used when sending requests to the
    handler.  The default is to use netstring-encoded JSON; you may instead set this to
    ``tnetstring'', which will cause Mongrel to use TNetStrings.
\end{description}
