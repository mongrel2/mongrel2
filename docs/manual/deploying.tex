...
own apps, with more to come as we do the 2.0 version:
...
move my configuration over to new machines with this setup, or deploy clusters.  I know as
long as there's the right user on the target, I'm set.

\item Use \href{http://www.gnu.org/software/screen/}{GNU screen} or die.

\item Keep your config.sqlite and the .py file in your chroot, and keep your content and
...
Actually if you're running any services as root that doesn't absolutely need to be you're doing
it wrong.
