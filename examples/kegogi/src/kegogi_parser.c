...
#endif
#define ParseARG_SDECL CommandList *commandList;
#define ParseARG_PDECL ,CommandList *commandList
#define ParseARG_FETCH CommandList *commandList = yypParser->commandList
#define ParseARG_STORE yypParser->commandList = commandList
#define YYNSTATE 25
#define YYNRULE 12
...
static const char *const yyTokenName[] = { 
  "$",             "NEWLINE",       "STRING",        "EQUALS",      
  "PATTERN",       "DICT_START",    "DICT_END",      "DEFAULTS",    
  "SEND",          "URL",           "EXPECT",        "NUMBER",      
  "error",         "param",         "params",        "dict",        
  "defaults",      "command",       "script",        "command_list",
};
#endif /* NDEBUG */
...
static const char *const yyRuleName[] = {
 /*   0 */ "script ::= command_list",
 /*   1 */ "command_list ::= command_list command",
 /*   2 */ "command_list ::= command_list defaults",
 /*   3 */ "command_list ::= command_list NEWLINE",
 /*   4 */ "command_list ::=",
 /*   5 */ "params ::= params param",
 /*   6 */ "params ::=",
 /*   7 */ "param ::= STRING EQUALS PATTERN",
 /*   8 */ "param ::= STRING EQUALS STRING",
 /*   9 */ "param ::= STRING EQUALS DICT_START params DICT_END",
 /*  10 */ "defaults ::= DEFAULTS params NEWLINE",
 /*  11 */ "command ::= SEND STRING URL params NEWLINE EXPECT NUMBER params NEWLINE",
};
#endif /* NDEBUG */
...
static void yy_reduce(
  ...
  **     break;
  */
      case 1: /* command_list ::= command_list command */
#line 41 "src/kegogi_parser.y"
{
...
{
           yygotominor.yy30 = calloc(sizeof(Command), 1);
           yygotominor.yy30->send.method = bstrcpy(yymsp[-7].minor.yy0->s1);
           yygotominor.yy30->send.uri = bstrcpy(yymsp[-6].minor.yy0->s1);
           yygotominor.yy30->send.host = (yymsp[-6].minor.yy0->s2 == NULL) ? NULL : bstrcpy(yymsp[-6].minor.yy0->s2);
           yygotominor.yy30->send.port = (yymsp[-6].minor.yy0->s3 == NULL) ? NULL : bstrcpy(yymsp[-6].minor.yy0->s3);
           yygotominor.yy30->send.params = yymsp[-5].minor.yy24;
...
#line 758 "src/kegogi_parser.c"
      ...
      /* (3) command_list ::= command_list NEWLINE */ yytestcase(yyruleno==3);
      /* (4) command_list ::= */ yytestcase(yyruleno==4);
        break;
  };
